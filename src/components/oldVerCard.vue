...
import MembersCardOldBg from "@/assets/oldVerBg.svg";
...
MCBgImageObj.src = MembersCardOldBg;
...
const handleResize = () => {
  ...
  const width = Math.min(
    (memberCardRef.value?.clientWidth ?? 0) - 40,
    stageSize.width,
  );
  ...
  <div class="container mx-auto">
    ...
    <div class="card card-compact shadow-xl">
      <div class="card-body">
        ...
        <p>
          注意：Chrome 请右键或长按 canvas 画布下载，Safari 暂不支持右键保存
          canvas
          元素。第一次加载可能需要等待外部字体载入，如果字体显示不正常请多刷新几次。
        </p>
        <p>
          如果你喜欢这个项目，请在
          <a href="https://github.com/mitian233/memberscard" class="underline"
            >GitHub</a
          >
          为我点一颗星
        </p>
